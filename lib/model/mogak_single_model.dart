...
class SingleMogakModel {
  ...
  factory SingleMogakModel.fromMap(Map<String, dynamic> map) {
    return SingleMogakModel(
      talks: map['talks'] != null ? List.from(map['talks']) : null,
      upProfiles:
  ...
  factory SingleMogakModel.fromJson(String source) =>
      SingleMogakModel.fromMap(json.decode(source) as Map<String, dynamic>);
}
